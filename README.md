...
The parameters generated by the AutoML best model are:<br>
<pre><code>KNeighborsClassifier(algorithm='auto',
                      leaf_size=30,
                       metric='l1',
                       metric_params=None,
                       n_jobs=1,
...
The hyperdrive tuned best model details can be given as:<br>
<img src="resources/hd_bestrun.png"><br><br>
...
The predict.py python script is used by the endpoint to interact with the registered best model. The data passed in the payload must be JSON serializable and the predict.py extracts data from the JSON body of the request and passes onto the model as input.<br>

The sample input can be given as:<br><br>
<img src="resources/input_1.png"><br><br>
<img src="resources/input_2.png"><br><br>
...
3. Enable *Deep Learning* in Classification while creating the AutoML experiment.

4. Perform data preprocessing such as feature selection by observing the influence of features on different models.
